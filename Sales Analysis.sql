...
SELECT DISTINCT(Product), SUM([Quantity Ordered]) AS [Quantity Ordered], Month
FROM Sales_Data
...
SELECT DISTINCT(Product), [Price Each],SUM([Quantity Ordered]) AS [Quantity Ordered], Month,
